...
/// 
bc_TurnApplication* bc_GameController_apply_turn(bc_GameController* arg, bc_TurnMessage* turn);
/// 
bc_InitialTurnApplication* bc_GameController_initial_start_turn_message(bc_GameController* arg);
/// 
